...
def main():
    ...
    parser.add_argument(
        '--kpt_thr', type=float, default=0.1, help='Keypoint score threshold')
    parser.add_argument(
        '--radius',
        type=int,
        default=4,
    ...
    person_results_list = CVFile(args.bbox_file).data
    hand_kp_list = []
    ...
    for frame_id, cur_frame in enumerate(mmcv.track_iter_progress(video)):
        ...
        # # for hand bbox input pkl
        # person_results = []
        # for bbox in person_results_list[count]:
        #     person = {}
        ...
        # print(pose_results[1]['keypoints'])
        # print(len(pose_results[1]['keypoints']))
        hand_kp_list.append(pose_results)
